...
export default class BlocksAPI extends Module {
   ...
   * @param tune
   */
  public update = async (id: string, data: Partial<BlockToolData>, tune?: any): Promise<BlockAPIInterface> => {
    ...
    const updatedBlock = await BlockManager.update(block, data, tune);
